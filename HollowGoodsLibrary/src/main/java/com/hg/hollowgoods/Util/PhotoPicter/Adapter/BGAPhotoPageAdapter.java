...
import com.hg.hollowgoods.Util.PhotoPicter.Util.BGABrowserPhotoViewAttacher;
import com.hg.hollowgoods.Util.PhotoPicter.Util.BGAPhotoPickerUtil;
import com.hg.hollowgoods.Util.PhotoPicter.Widget.BGAImageView;
...
public class BGAPhotoPageAdapter extends PagerAdapter {
    ...
    public View instantiateItem(ViewGroup container, int position) {
        ...
        BGAImage.display(imageView, R.mipmap.bga_pp_ic_holder_dark, mPreviewPhotos.get(position), BGAPhotoPickerUtil.getScreenWidth(), BGAPhotoPickerUtil.getScreenHeight(), true);
