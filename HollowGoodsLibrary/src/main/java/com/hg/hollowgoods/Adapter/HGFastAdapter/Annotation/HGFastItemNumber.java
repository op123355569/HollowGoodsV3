...
@Documented
public @interface HGFastItemNumber {
     ...
     * @return ItemMode
     */
    ItemMode itemMode() default ItemMode.Input;
     ...
     */
    @Deprecated
    Class<?> singleChoiceNameClass() default HGFastItemNumber.class;
