package com.hg.hollowgoods.Widget.FloatingSearchView;
...
import com.hg.hollowgoods.Widget.FloatingSearchView.suggestions.SearchSuggestionsAdapter;
...
import com.hg.hollowgoods.Widget.FloatingSearchView.util.adapter.GestureDetectorListenerAdapter;
import com.hg.hollowgoods.Widget.FloatingSearchView.util.adapter.OnItemTouchListenerAdapter;
import com.hg.hollowgoods.Widget.FloatingSearchView.util.adapter.TextWatcherAdapter;
import com.hg.hollowgoods.Widget.FloatingSearchView.util.view.MenuView;
import com.hg.hollowgoods.Widget.FloatingSearchView.util.view.SearchInputView;
 ...
 * search.
 * <p>
 * Created by HollowGoods on 2019-5-20.
 */
...
public class FloatingSearchView extends FrameLayout {
    ...
    private OnArrowActionClickListener mOnArrowActionClickListener;
    ...
    public interface OnArrowActionClickListener {
        void onArrowClicked();
    }
        ...
        mLeftAction.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isSearchBarFocused()) {
                    setSearchFocusedInternal(false);
                    if (mOnArrowActionClickListener != null) {
                        mOnArrowActionClickListener.onArrowClicked();
                    }
                } else {
    ...
    public void setOnArrowActionClickListener(OnArrowActionClickListener listener) {
        this.mOnArrowActionClickListener = listener;
    }
