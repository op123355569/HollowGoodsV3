...
public class Ex12Adapter extends MultiItemTypeAdapter<CommonBean> {
    ...
    public Ex12Adapter(Context context, List<CommonBean> datas) {
        super(context, datas);
        addItemViewDelegate(Constants.LIST_ITEM_TYPE_1, new ItemEx12_1());
        addItemViewDelegate(Constants.LIST_ITEM_TYPE_2, new ItemEx12_2());
        addItemViewDelegate(Constants.LIST_ITEM_TYPE_HEADER, new itemExHead());
    }
