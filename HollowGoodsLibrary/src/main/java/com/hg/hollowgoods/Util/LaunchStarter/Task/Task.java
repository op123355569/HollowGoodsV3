...
import com.hg.hollowgoods.Util.LaunchStarter.Utils.DispatcherExecutor;
...
public abstract class Task implements ITask {
    ...
    protected Context mContext = ApplicationBuilder.create();
     ...
     *
     * @return List<Class < ? extends Task>>
     */
    @Override
