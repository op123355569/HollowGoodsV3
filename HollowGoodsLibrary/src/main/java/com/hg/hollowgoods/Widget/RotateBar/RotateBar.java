package com.hg.hollowgoods.Widget.RotateBar;
...
public class RotateBar extends FrameLayout {
    ...
    private ArrayList<RotateBarBasic> mRatingBars;
    ...
    public RotateBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        final TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, R.styleable.RotateBar, 0, 0);
        mCenterText = attributes.getString(R.styleable.RotateBar_ratingCenterTitle);//中心标题
        mCenterTextSize = attributes.getDimensionPixelSize(R.styleable.RotateBar_centerTitleSize, DensityUtils.dp2px(context, 20));//标题字体大小
        mRatedColor = attributes.getColor(R.styleable.RotateBar_ratingRatedColor, 0);
        mUnratedColor = attributes.getColor(R.styleable.RotateBar_ratingUnratedColor, 0);
        mTitleColor = attributes.getColor(R.styleable.RotateBar_ratingTitleColor, 0);
        mOutlineColor = attributes.getColor(R.styleable.RotateBar_ratingOutlineColor, 0);
        mCenterTextColor = attributes.getColor(R.styleable.RotateBar_ratingCenterColor, Color.WHITE);
        mDefaultColor = attributes.getColor(R.styleable.RotateBar_ratingDefaultColor, 0);
        isShowTitle = attributes.getBoolean(R.styleable.RotateBar_ratingTitleVisible, true);
        mRatingMax = attributes.getInt(R.styleable.RotateBar_ratingMax, 0);
        attributes.recycle();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShow) {
            ...
            for (RotateBarBasic ratingBar : mRatingBars) {
    ...
    public void addRatingBar(RotateBarBasic ratingBar) {
        mRatingBars.add(ratingBar);
    }

    public void removeRatingBar(RotateBarBasic ratingBar) {
    ...
    private void initRatingBar() {
        ...
        for (int i = 0; i < dividePart; i++) {
            ...
            RotateBarBasic ratingBar = mRatingBars.get(i);
