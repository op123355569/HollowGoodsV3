...
public class SamplesNtbActivity extends Activity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex_35_samples_ntb);
        initUI();
    }
    ...
    private void initUI() {
        ...
        models1.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), Color.WHITE
                ).build()
        );
        models1.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), Color.LTGRAY
                ).build()
        );
        models1.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), Color.GRAY
                ).build()
        );
        models1.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), Color.DKGRAY
                ).build()
        );
        ...
        models2.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), Color.YELLOW
                ).build()
        );
        models2.add(
                new NavigationTabBar.Model.Builder(
        ...
        models3.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), Color.RED
                ).build()
        );
        models3.add(
                new NavigationTabBar.Model.Builder(
        ...
        models4.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), bgColor
                ).build()
        );
        models4.add(
                new NavigationTabBar.Model.Builder(
        ...
        models6.add(
                new NavigationTabBar.Model.Builder(
                        getResources().getDrawable(R.drawable.ic_android_white_24dp), randomColor()
                ).build()
        );
        models6.add(
                new NavigationTabBar.Model.Builder(
