...
public class BGAXUtilsImageLoader extends BGAImageLoader {
    ...
    @Override
    public void display(final ImageView imageView, String path, @DrawableRes int loadingResId, @DrawableRes int failResId, int width, int height, final DisplayDelegate delegate, boolean needGif) {
